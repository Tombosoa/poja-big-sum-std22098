package com.poja.poja_big_sum_std22098.endpoint.event;
...
public class EventServiceInvoker implements Consumer<EventConsumer.TypedEvent> {
  ...
  public void accept(EventConsumer.TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.poja.poja_big_sum_std22098.endpoint.event.gen");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.poja.poja_big_sum_std22098.service.event."

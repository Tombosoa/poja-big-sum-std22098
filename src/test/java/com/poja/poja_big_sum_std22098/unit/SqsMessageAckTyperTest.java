package com.poja.poja_big_sum_std22098.unit;
...
import com.poja.poja_big_sum_std22098.endpoint.event.EventConsumer;
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent(
            "com.poja.poja_big_sum_std22098.endpoint.event.gen.UuidCreated", payload);
